...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile drawer — rendered outside nav so it can cover full viewport */}
      {/* Backdrop */}
      <div
      ...
      >
        ...
        >
          ...
          >
            <span
              className="text-[13px] tracking-[0.3em] text-white font-light uppercase"
              style={{ fontFamily: "var(--font-playfair, serif)" }}
            >
              Luminus
            </span>
        ...
        <nav className="flex-1 px-6 py-8 flex flex-col gap-1">
          ...
          <Link
            href="/lentes"
            className="group flex items-center gap-3 py-3 text-[11px] font-medium text-white/50 hover:text-white uppercase tracking-[0.3em] transition-colors duration-200"
            onClick={closeMenu}
          >
            <span
              className="w-0 group-hover:w-4 h-px bg-[#d4af37] transition-all duration-300 ease-out"
              aria-hidden="true"
            />
            Catálogo
          </Link>
          ...
          {session ? (
            <>
              {session.user.role === "ADMIN" && (
                <Link
                  href="/admin"
                  className="group flex items-center gap-3 py-3 text-[11px] text-[#d4af37]/50 hover:text-[#d4af37] uppercase tracking-[0.25em] transition-colors duration-200"
                  onClick={closeMenu}
                >
            ...
            <Link
              href="/auth/login"
              className="group flex items-center gap-3 py-3 text-[11px] text-white/50 hover:text-white uppercase tracking-[0.3em] transition-colors duration-200"
              onClick={closeMenu}
            >
        ...
        {session && (
          ...
          >
            <button
              ...
              className="flex items-center gap-2.5 text-[10px] text-white/30 hover:text-white/60 uppercase tracking-[0.25em] transition-colors duration-200"
            >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at bottom left, rgba(212,175,55,0.06) 0%, transparent 70%)",
          }}
        />
      </div>
    </>
