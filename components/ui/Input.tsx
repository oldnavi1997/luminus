    ...
    return (
      <div className="space-y-1.5">
        ...
        <input
          ...
          id={id}
          className={cn(
            "w-full px-3.5 py-[7px] bg-white border text-sm text-[#111111] placeholder:text-[#111111]/25 focus:outline-none focus:border-[#d4af37] transition-colors duration-200",
