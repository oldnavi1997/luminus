...
export default function cloudinaryLoader({ src, width, quality }: LoaderProps): string {
  ...
  // q_auto lets Cloudinary pick per-image instead of a flat q_75. Medido sobre
  // el master, esta recompresión es invisible (PSNR 51 dB): la calidad se
  // decide al subir, en `uploadProductImage`, no acá.
